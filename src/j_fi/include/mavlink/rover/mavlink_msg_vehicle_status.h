...
#define MAVLINK_MSG_ID_VEHICLE_STATUS_LEN 18
#define MAVLINK_MSG_ID_VEHICLE_STATUS_MIN_LEN 18
#define MAVLINK_MSG_ID_191_LEN 18
#define MAVLINK_MSG_ID_191_MIN_LEN 18

#define MAVLINK_MSG_ID_VEHICLE_STATUS_CRC 111
#define MAVLINK_MSG_ID_191_CRC 111
...
static inline uint16_t mavlink_msg_vehicle_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, uint64_t armed_time, uint8_t arming_state, uint8_t nav_state)
{
...
{
    return mavlink_msg_vehicle_status_pack(system_id, component_id, msg, vehicle_status->timestamp, vehicle_status->armed_time, vehicle_status->arming_state, vehicle_status->nav_state);
}
...
{
    return mavlink_msg_vehicle_status_pack_chan(system_id, component_id, chan, msg, vehicle_status->timestamp, vehicle_status->armed_time, vehicle_status->arming_state, vehicle_status->nav_state);
}
...
static inline void mavlink_msg_vehicle_status_send(mavlink_channel_t chan, uint64_t timestamp, uint64_t armed_time, uint8_t arming_state, uint8_t nav_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_VEHICLE_STATUS_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_vehicle_status_send(chan, vehicle_status->timestamp, vehicle_status->armed_time, vehicle_status->arming_state, vehicle_status->nav_state);
#else
 ...
 */
static inline void mavlink_msg_vehicle_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint64_t armed_time, uint8_t arming_state, uint8_t nav_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
