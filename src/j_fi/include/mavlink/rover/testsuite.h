...
static void mavlink_test_trajectory_setpoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_trajectory_setpoint_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_trajectory_setpoint_pack(system_id, component_id, &msg , packet1.timestamp , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.vel_x , packet1.vel_y , packet1.vel_z , packet1.acc_x , packet1.acc_y , packet1.acc_z , packet1.jerk_x , packet1.jerk_y , packet1.jerk_z , packet1.yaw , packet1.yawspeed );
    mavlink_msg_trajectory_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_trajectory_setpoint_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_trajectory_setpoint_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.vel_x , packet1.vel_y , packet1.vel_z , packet1.acc_x , packet1.acc_y , packet1.acc_z , packet1.jerk_x , packet1.jerk_y , packet1.jerk_z , packet1.yaw , packet1.yawspeed );
    mavlink_msg_trajectory_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_vehicle_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_vehicle_status_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vehicle_status_pack(system_id, component_id, &msg , packet1.timestamp , packet1.armed_time , packet1.arming_state , packet1.nav_state );
    mavlink_msg_vehicle_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vehicle_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.armed_time , packet1.arming_state , packet1.nav_state );
    mavlink_msg_vehicle_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_vehicle_status_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vehicle_status_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.armed_time , packet1.arming_state , packet1.nav_state );
    mavlink_msg_vehicle_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
